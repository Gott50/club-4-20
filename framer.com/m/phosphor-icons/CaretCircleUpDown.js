let Component;
var CaretCircleUpDown_default = (React) => {
  if (!Component) {
    ...
    const CaretCircleUpDown = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  CaretCircleUpDown_default as default
};
