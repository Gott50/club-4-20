let Component;
var PhoneIncoming_default = (React) => {
  if (!Component) {
    ...
    const PhoneIncoming = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
