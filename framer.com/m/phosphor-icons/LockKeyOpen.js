...
var LockKeyOpen_default = (React) => {
  if (!Component) {
    ...
    const LockKeyOpen = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  LockKeyOpen_default as default
};
