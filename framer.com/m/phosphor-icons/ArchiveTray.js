...
var ArchiveTray_default = (React) => {
  if (!Component) {
    ...
    const ArchiveTray = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  ArchiveTray_default as default
};
