let Component;
var GoogleChromeLogo_default = (React) => {
  if (!Component) {
    ...
    const GoogleChromeLogo = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  GoogleChromeLogo_default as default
};
