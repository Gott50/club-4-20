...
var ChartPolar_default = (React) => {
  if (!Component) {
    ...
    const ChartPolar = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
