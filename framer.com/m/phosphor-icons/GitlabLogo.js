...
var GitlabLogo_default = (React) => {
  if (!Component) {
    ...
    const GitlabLogo = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
