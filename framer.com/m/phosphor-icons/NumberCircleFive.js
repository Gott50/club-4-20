let Component;
var NumberCircleFive_default = (React) => {
  if (!Component) {
    ...
    const NumberCircleFive = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  NumberCircleFive_default as default
};
