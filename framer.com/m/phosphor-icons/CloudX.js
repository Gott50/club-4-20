...
var CloudX_default = (React) => {
  if (!Component) {
    ...
    const CloudX = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
