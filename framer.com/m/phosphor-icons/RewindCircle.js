let Component;
var RewindCircle_default = (React) => {
  if (!Component) {
    ...
    const RewindCircle = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  RewindCircle_default as default
};
