let Component;
var TrademarkRegistered_default = (React) => {
  if (!Component) {
    ...
    const TrademarkRegistered = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  TrademarkRegistered_default as default
};
