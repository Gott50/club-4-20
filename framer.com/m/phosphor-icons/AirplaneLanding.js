...
var AirplaneLanding_default = (React) => {
  if (!Component) {
    ...
    const AirplaneLanding = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  AirplaneLanding_default as default
};
