let Component;
var NumberCircleSix_default = (React) => {
  if (!Component) {
    ...
    const NumberCircleSix = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  NumberCircleSix_default as default
};
