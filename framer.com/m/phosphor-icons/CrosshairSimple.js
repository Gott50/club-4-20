let Component;
var CrosshairSimple_default = (React) => {
  if (!Component) {
    ...
    const CrosshairSimple = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  CrosshairSimple_default as default
};
