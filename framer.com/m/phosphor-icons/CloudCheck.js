...
var CloudCheck_default = (React) => {
  if (!Component) {
    ...
    const CloudCheck = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
