...
var GlobeSimple_default = (React) => {
  if (!Component) {
    ...
    const GlobeSimple = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  GlobeSimple_default as default
};
