...
var FolderPlus_default = (React) => {
  if (!Component) {
    ...
    const FolderPlus = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
