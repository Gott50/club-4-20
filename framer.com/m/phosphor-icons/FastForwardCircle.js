let Component;
var FastForwardCircle_default = (React) => {
  if (!Component) {
    ...
    const FastForwardCircle = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  FastForwardCircle_default as default
};
