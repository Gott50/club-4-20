...
var SmileyWink_default = (React) => {
  if (!Component) {
    ...
    const SmileyWink = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
