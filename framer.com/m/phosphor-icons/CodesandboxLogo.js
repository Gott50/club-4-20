...
var CodesandboxLogo_default = (React) => {
  if (!Component) {
    ...
    const CodesandboxLogo = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  CodesandboxLogo_default as default
};
