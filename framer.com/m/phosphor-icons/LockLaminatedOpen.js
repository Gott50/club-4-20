let Component;
var LockLaminatedOpen_default = (React) => {
  if (!Component) {
    ...
    const LockLaminatedOpen = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  LockLaminatedOpen_default as default
};
