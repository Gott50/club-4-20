...
var Images_default = (React) => {
  if (!Component) {
    ...
    const Images = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
