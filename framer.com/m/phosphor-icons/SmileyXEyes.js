...
var SmileyXEyes_default = (React) => {
  if (!Component) {
    ...
    const SmileyXEyes = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  SmileyXEyes_default as default
};
