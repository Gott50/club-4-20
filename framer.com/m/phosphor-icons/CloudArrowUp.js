let Component;
var CloudArrowUp_default = (React) => {
  if (!Component) {
    ...
    const CloudArrowUp = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  CloudArrowUp_default as default
};
