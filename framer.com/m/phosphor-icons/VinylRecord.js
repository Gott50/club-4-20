...
var VinylRecord_default = (React) => {
  if (!Component) {
    ...
    const VinylRecord = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  VinylRecord_default as default
};
