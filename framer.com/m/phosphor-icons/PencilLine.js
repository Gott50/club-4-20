...
var PencilLine_default = (React) => {
  if (!Component) {
    ...
    const PencilLine = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
