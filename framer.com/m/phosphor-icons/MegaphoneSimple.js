...
var MegaphoneSimple_default = (React) => {
  if (!Component) {
    const weights = /* @__PURE__ */ new Map([
      ...
      [
        "thin",
        /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("path", { d: "M219.41,90.5l-176-54A12,12,0,0,0,28,48V192a12,12,0,0,0,12,12,12.41,12.41,0,0,0,3.45-.5L132,176.32V192a12,12,0,0,0,12,12h32a12,12,0,0,0,12-12V159.14l31.39-9.63A12.06,12.06,0,0,0,228,138V102A12,12,0,0,0,219.41,90.5ZM41.12,195.84A4,4,0,0,1,36,192V48a4,4,0,0,1,1.6-3.2A4,4,0,0,1,40,44a3.89,3.89,0,0,1,1.07.15L132,72.05V168ZM180,192a4,4,0,0,1-4,4H144a4,4,0,0,1-4-4V173.87l40-12.27Zm40-54a4,4,0,0,1-2.88,3.84l-.05,0L140,165.5v-91l77.12,23.66A4,4,0,0,1,220,102Z" }))
      ]
    ]);
    const MegaphoneSimple = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", { ref, ...props }, weights.get(props.weight)));
...
export {
  __FramerMetadata__,
  MegaphoneSimple_default as default
};
